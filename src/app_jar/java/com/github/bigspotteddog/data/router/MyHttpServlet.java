...
import com.github.bigspotteddog.data.controller.ErrorResponse;
...
public class MyHttpServlet extends HttpServlet {
    ...
    protected String getId(final HttpServletRequest req) throws UnsupportedEncodingException {
        ...
        final Map<String, String> map = com.github.bigspotteddog.util.Utils.getParts(path, "/{{resource}}/{{id}}");
