...
public class ShardedCounter {
     ...
     */
    public long addShards(final int count) {
        final Key counterKey = KeyFactory.createKey(Counter.KIND, counterName);
        return incrementPropertyTx(counterKey, Counter.SHARD_COUNT, count, INITIAL_SHARDS + count);
    }
     ...
     */
    private long incrementPropertyTx(final Key key, final String prop, final long increment, final long initialValue) {
